...
```bash
pip install https://github.com/ViaPost-io/viapost-python/releases/download/v0.1.2/viapost-0.1.2-py3-none-any.whl
```
...
The release also includes the source distribution (`viapost-0.1.2.tar.gz`) and checksums. The wheel
