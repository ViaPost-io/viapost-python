...
1. Construction validates the API key, secure base URL, timeout, response limit, and retry settings.
...
10. Sync and async resources expose send, messages, domains, templates, webhooks, automations, and usage operations equivalent to the Node SDK.
